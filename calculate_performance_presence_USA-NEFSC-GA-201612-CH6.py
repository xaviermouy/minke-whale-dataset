...
# Annotation file:
# annot_files=[]
# annot_files.append(r"D:\NOAA\2022_Minke_whale_detector\manual_annotations\continuous_datasets\USA-NEFSC-GA-201612-CH6\Annotations_dataset_USA-NEFSC-GA-201611-CH6 annotations_withSNR.nc")
...
# # output folder
# out_dir = r"D:\NOAA\2022_Minke_whale_detector\results\spectro-5s_fft-0.128_step-0.064_fmin-0_fmax-800_no-norm\USA-NEFSC-GA-201612-CH6\performance_results"

# Annotation file:
annot_files=[]
annot_files.append(r"D:\NOAA\2022_Minke_whale_detector\manual_annotations\continuous_datasets\USA-NEFSC-GA-201612-CH6\Annotations_dataset_USA-NEFSC-GA-201611-CH6 annotations_withSNR.nc")
# Detection folder or detection sqllite file
detec_file = r"D:\NOAA\2022_Minke_whale_detector\results\spectro-5s_fft-0.256_step-0.03_fmin-0_fmax-800_no-norm\USA-NEFSC-GA-201612-CH6\wrong\detections.sqlite"
# output folder
out_dir = r"D:\NOAA\2022_Minke_whale_detector\results\spectro-5s_fft-0.256_step-0.03_fmin-0_fmax-800_no-norm\USA-NEFSC-GA-201612-CH6\wrong"


# restrictions on min and max dates:
date_min = '2016-12-17 00:15:00'  # date string (e.g. '2020-11-02 00:00:00') or None
date_max = '2016-12-28 00:00:00'  # # date string (e.g. '2020-11-02 00:00:00') or None
