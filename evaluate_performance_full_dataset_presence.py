...
# annot_file = r"C:\Users\xavier.mouy\Documents\Projects\2022_DFO_fish_catalog\RCA_Analysis\manual-analysis\Fernie_spring_complete.txt"
...
date_min = "2016-12-26 04:15:00"  # date string or None
date_max = "2017-02-23 18:16:30"  # date string or None
...
fig.tight_layout()
fig.savefig(
    os.path.join(out_dir, "Performance_" + integration_time + "_graph.png")
)

# save CSV files
performance_PRF.to_csv(
    os.path.join(
        out_dir, "Performance_" + integration_time + "_full_dataset.csv"
    ),
    index=False,
)
performance_per_interval_count.to_csv(
    os.path.join(out_dir, "Performance_per_" + integration_time + ".csv"),
    index=False,
)
