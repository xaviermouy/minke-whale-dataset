...
#annot_file = r'D:\NOAA\2022_Minke_whale_detector\ketos\dataset_20221214T163342\test.csv'
#detec_dir = r'D:\NOAA\2022_Minke_whale_detector\ketos\dataset_20221214T163342\databases\spectro-5s_fft-0.128_step-0.064_fmin-0_fmax-800_with-norm\models\5s_bs128_ep50\narval\run_results'
#thresholds = np.arange(0.5,1.01,0.01)
#class_pos ='MW'
#change_detec_label = None

annot_file = r'D:\NOAA\2022_BC_fish_detector\ketos\dataset_20230203T162039\test.csv'
detec_dir = r'D:\NOAA\2022_BC_fish_detector\ketos\dataset_20230203T162039\databases\spectro-0.4s_fft-0.128_step-0.005_fmin-0_fmax-800_no-norm\model\bs256_ep50\run_results\with_smoothing_3_ConfMin30'
thresholds = np.arange(0.1,1.01,0.01)
class_pos ='FS'
change_detec_label = 'FS'
...
for an_idx,  an in annot.iterrows():
    ...
    if change_detec_label != None:
        detec['Class']=change_detec_label
